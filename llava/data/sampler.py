...
from .utils import (
    get_length_grouped_indices_auto_single, get_mm_length_grouped_indices, get_mm_length_grouped_indices_auto, get_variable_length_grouped_indices,
)
...
class LengthGroupedSampler(Sampler):
    ...
    def __init__(
        ...
        Args:
            ...
            variable_length (bool, optional): Whether the dataset has variable length. Defaults to ``False``.
            group_by_modality (bool, optional): Whether to group by modality. Defaults to ``False``.
            group_by_modality_auto (bool, optional): Whether to automatically group by modality. Defaults to ``False``.
        """
        super().__init__()
        if lengths is None:
        ...
        self.group_by_modality_auto: bool = group_by_modality_auto
    ...
    def __iter__(self) -> Iterator[List[Any]]:
        ...
        if self.variable_length:
            ...
            if self.group_by_modality:
                ...
                indices = get_mm_length_grouped_indices_auto(self.lengths, self.batch_size, self.world_size, generator=self.generator)
            else:
