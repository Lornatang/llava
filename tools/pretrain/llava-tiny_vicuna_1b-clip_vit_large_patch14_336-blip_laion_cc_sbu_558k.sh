...
torchrun --nproc_per_node=1 --nnodes=1 --node_rank=0 --master_addr=127.0.0.1 --master_port=10000 \
    ...
    --output_dir "./results/pretrain/llava-tiny_vicuna_1b-clip_vit_large_patch14_336-blip_laion_cc_sbu_558k" \
    --num_train_epochs 1 \
    ...
    --report_to "wandb" \
    --run_name "llava-tiny_vicuna_1b-clip_vit_large_patch14_336-blip_laion_cc_sbu_558k" \
