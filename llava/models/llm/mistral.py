...
__all__ = [
    "LlavaMistralConfig", "LlavaMistralModel", "LlavaMistralForCausalLM",
]


class LlavaMistralConfig(MistralConfig):
    """Configuration class for llava_mistral model."""
    model_type: str = "llava_mistral"


class LlavaMistralModel(LlavaMetaModel, MistralModel):
    """LlavaMistralModel model class."""
    config_class: LlavaMistralConfig = LlavaMistralConfig

    def __init__(self, config: MistralConfig) -> None:
        """Initialize the LlavaMistralModel model.

        Args:
            config (MistralConfig): Configuration for the LlavaMistralModel model.
        """
        super().__init__(
            config=config,
        )
...
class LlavaMistralForCausalLM(MistralForCausalLM, LlavaMetaForCausalLM):
    """LlavaMistralForCausalLM model for causal language modeling."""
    config_class: LlavaMistralConfig = LlavaMistralConfig

    def __init__(self, config: MistralConfig) -> None:
        """Initialize the LlavaMistralForCausalLM model for causal language modeling.

        Args:
            config (MistralConfig): Configuration for the LlavaMistralForCausalLM model.
        """
        super().__init__(
            config=config,
        )
        ...
        self.model: LlavaMistralModel = LlavaMistralModel(config)
    ...
    def forward(
        ...
        """Forward pass for the Llava Mistral model.
    ...
    def get_model(self) -> LlavaMistralModel:
        """Get the underlying Llava Mistral model."""
        return self.model
    ...
    def prepare_inputs_for_generation(
        ...
        inputs = super().prepare_inputs_for_generation(input_ids, past_key_values, inputs_embeds=inputs_embeds, **kwargs)
